...
@includesrc ParsedStrStl.h 7 18
...
@includesrc ParsedStrUnopt.h 4 17

@includesrc ParsedStrUnopt.cpp 7 74
...
@includesrc ParsedStrOptAlloc.h 4 18

@includesrc ParsedStrOptAlloc.cpp 8 67
...
@includesrc ParsedStrOptOneArray.h 4 17

@includesrc ParsedStrOptOneArray.cpp 8 64
...
@includesrc ParsedStrOptOffsets.h 4 17

@includesrc ParsedStrOptOffsets.cpp 8 64
...
@includesrc ParsedStrOptNoOffsets.h 4 16

@includesrc ParsedStrOptNoOffsets.cpp 8 48
...
@includesrc ParsedStrOptNoOffsetsNoDup.cpp 14 32
...
@includesrc ParsedStrOptCommon.h 4 20

@includesrc ParsedStrOptCommon.cpp 8 56

This trick can be used in combination with other optimizations.

h2. Comparing different approaches.

Here are the file sizes of various versions, compiled with gcc and stripped of symbols (to get the most accurate picture of the size of the code).

@includetxt parsedstr-size-stats.html

The interesting metric is file size delta, which shows how much bigger a given implementation of @ParsedStr@ class is compared to a version that does nothing.

STL version is the worst by a wide margin. Not only it's more than 8 times bigger than the smallest version but also 4 times bigger than the biggest non-STL version.

Even within relatively similar in size non-STL versions, the smallest version is almost half the size of the third smallest versions.
